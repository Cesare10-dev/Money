        ...
        <div className="px-4 py-6">
          <div className="space-y-6">
            {[
              ...
              { label: "Email address", value: "johndoe@bla.com" },
            ].map((field) => (
              <div key={field.label}>
  ...
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        ...
        <AppScreen.Subtitle>August 24 2023</AppScreen.Subtitle>
      </MotionAppScreenHeader>
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
...
export const features = [
  {
    ...
    description:
      "For every friend you invite to Money, you get insider notifications 5 seconds sooner. And it is 10 seconds if you invite an insider.",
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
